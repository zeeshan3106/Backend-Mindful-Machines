 ...
 */
export default function useThrottledCallback<T extends (...args: any) => ReturnType<T>>(func: T, wait: number, { leading, trailing, flushOnExit }?: CallOptions): DebouncedState<T>;
