...
useEffect(() => {
  ...
  axios.get('http://localhost:8000/api/frontend/DSAFeeds',{
    params:{
      page:thispage
    }
  },{
...
<div className='mt-40 bg-white p-20 font-bold text-[20px] rounded-md shadow-md'>
