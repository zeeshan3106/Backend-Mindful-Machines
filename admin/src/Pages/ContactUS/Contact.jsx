...
const [thispages, setthispages ]=useState()
...
useEffect(() => {
  ...
  axios.get('http://localhost:8000/api/frontend/getcontacts',
    ...
    .then(res => {
      ...
      setcount(res.data.ContactsCounts)
      console.log(res.data.ContactsCounts)
    })
